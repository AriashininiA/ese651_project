...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    rewards = {
        ...
        "lookahead_alignment_reward_scale": 1.0,
        "lookahead_progress_reward_scale": 0.75,
        "racing_line_speed_reward_scale": 1.0,
        "brake_penalty_reward_scale": -0.6,
        "lateral_motion_penalty_reward_scale": -0.35,
        "edge_safety_reward_scale": 0.25,
        "exit_commitment_reward_scale": 0.75,
        "exit_alignment_reward_scale": 0.75,
